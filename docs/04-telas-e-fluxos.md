...
| # | Tela | Conteúdo |
|---|---|---|
| 57 | **Atividades embaixo da matéria** (Fase 24): na matéria lançada por avaliações, cada atividade do trimestre aparece embaixo do nome com pontilhado até a nota — "Planta Baixa ······ 10,00/10" —, alinhada à nota da matéria. Quando as atividades passam do teto, a linha diz "média das 2 atividades" e a folha da matéria mostra "nota 10 de 10" com a conta ("somam 20 de 20 pontos — passa do limite de 10, então a nota é a proporção: 10"). |
