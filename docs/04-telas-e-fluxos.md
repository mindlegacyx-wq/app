...
| 36 | **Notas** (`/estudos/notas`, Fase 11) | Régua no topo (média mínima · períodos · escala) · seletor de ano quando há mais de um · card por matéria com média do ano, um bloco por período (verde ≥ média, vermelho abaixo, tracejado sem nota) e a frase "Precisa de X no 3º trimestre para fechar com 6" com status colorido · toque abre a matéria (notas por período, lançar/editar/excluir) · "Configurar" abre a régua da escola (0–10 ou 0–100, média mínima, 2/3/4 períodos) |
